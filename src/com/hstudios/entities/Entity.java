...
public class Entity {
	...
	public static BufferedImage LIFECOIN_EN = Game.spritesheet.getSprite(5*16, 0,16,16);
	public static BufferedImage GUN_EN = Game.spritesheet.getSprite(6*16, 0,16,16);

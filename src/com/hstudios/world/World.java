...
import com.hstudios.entities.Bullet;
import com.hstudios.entities.Enemy;
import com.hstudios.entities.Entity;
import com.hstudios.entities.GUN;
import com.hstudios.entities.LifeCoin;
				...
				for(int xx = 0; xx < map.getWidth(); xx++) {
					for(int yy = 0; yy < map.getHeight(); yy++) {
						...
						if(pixelAtual == 0xFF000000) {
							...
							//LIFE COIN
							LifeCoin coin = new LifeCoin(xx*16,yy*16,16,16,Entity.LIFECOIN_EN);
